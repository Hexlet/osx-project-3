        ...
        while (!isPause) {
            @autoreleasepool {
                ...
                dispatch_async(dispatch_get_main_queue(), ^{
                    ...
                    [generationLabel setStringValue:[NSString stringWithFormat:@"Generation: %i",(int)countGenetarion]];
                    [bestIndividualLabel setStringValue:[NSString stringWithFormat:@"Best individual match - %i%%",(int)maxLength]];
